        ...
        <div className='mclubbox1'>
            ...
            <div className="mtwo-column-layout">
                ...
                <div className="smvideo-container-large2">
                        ...
                        <a href="https://www.ibaglobalsearch.com/register" className="smregister-btn8">PRE BOOKED</a>
                        <a href="https://www.ibaglobalsearch.com/register" className="smregister-btn2">SELL NOW</a>
                    </div>
                </div>
                <div className="mtwo-column-layout">
                {/* First column with one large video */}
